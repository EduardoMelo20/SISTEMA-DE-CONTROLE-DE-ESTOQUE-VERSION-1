...
//lembretes 1- colocar default's em todos os switch's

//O SISTEMA DE INSERÇÃO DE INFORMAÇOES DA OPÇÃO 1(NOTEBOOKS) JA FOI FEITA. FALTA DE TODOS OS OUTROS
//FALTA O SISTEMA DE EXCLUSÃO
//FALTA O SISTEMA DE EDIÇÃO DE QUANTIDADE
